...
This repository contains the conceptual definition and theoretical framework for **Original HTML**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── original-html.tex    # LaTeX dissertation
├── whitepaper/
│   └── original-html.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025originalhtml,
  author = {Vega, Adam Eren},
  title = {Original HTML: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/original-html}
}
```
